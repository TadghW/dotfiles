...
##### To do & Fixes:
 ...
 - neotree symbols are currently all question marks, should fix that (the solution was to install a new font that had all sufficient symbol support and setting it in therminal, I used nerd-fonts for this)
